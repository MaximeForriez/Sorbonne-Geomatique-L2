...
let geolocalisation = /*Trouver et compléter la commande pour obtenir la géolocalisation*/;
...
if(navigateurEnLigne)
{
	if(geolocalisation)
	{
		geolocalisation./*Trouver le nom de la méthode permettant de localiser votre ordinateur*/(coordonnees,erreur,options);
	}
	else
	{
		let paragraphe1 = document.getElementById("para1");
